...
public class GuidSerializationTests
{
    ...
    private static (IServiceProvider sp, CaptureRequestHandler handler) BuildProvider()
    {
        ...
        var handler = new CaptureRequestHandler("{ \"data\": { \"createItem\": { \"id\": \"00000000-0000-0000-0000-000000000000\" } } }");
    ...
    [Fact]
    public async Task Mutation_variables_should_serialize_guids_as_strings()
    {
        // Arrange
        ...
        // Expect quoted GUIDs in payload
        body.ShouldContain("\"" + parent.ToString("D") + "\"");
        body.ShouldContain("\"" + template.ToString("D") + "\"");
    }
}
